...
public class CommanderUnDisque extends HttpServlet {
    List<Disques> selectedDisquesList=new ArrayList<Disques>();
	private static final long serialVersionUID = 1L;
       
    public List<Disques> getSelectedDisquesList() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				nom = Identification.chercheNom(cookies,s);
			    ...
			    Disques disque = new Disques(request.getParameter("code"),request.getParameter("prix"));
